...
**Step 4**: In the settings menu, change the simulation length to 200 and make sure that your analysis algorithm is set to "4th order runge-kutta" (this makes InsightMaker behave more like a continuous growth model).
