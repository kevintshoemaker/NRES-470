...
- How can we upscale detailed processes at the level of individuals (e.g., behavioral interactions) into patterns at the population scale? (emergent properties!)

![](Wolves_and_bones.jpg)

- What is the relative importance of direct (**predation, competition**) vs. indirect (induced behavioural change; e.g., fear) interactions in determining the effect of one species on others?    
...
- To what extent will climate change decouple trophic links due to **phenological mismatches**?    
