...
6. Open the **Equation** window for the [Flow] and set it to [Stock]x[factor]. That is, the rate of inflow into the [Stock] is equal to the value of the [Stock] multiplied by the value of *factor*.
...
**Q** Can you model the puffball example from earlier in the lecture? How many puffballs are in the population after two generations??
