...
The species has been federally listed since 1978 (some population segments listed as "Threatened", and others as "Endangered". When a species is listed, the Endangered Species Act (ESA) requires that a recovery plan be drafted whose goal is to eventually remove the species from the list.
...
For this model we will follow Crowder et al. in assuming no stochasticity or uncertainty in any of these parameters. 
