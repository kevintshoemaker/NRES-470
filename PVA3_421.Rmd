...
The loggerhead sea turtle, *C. caretta*, is a large marine turtle that nests along the Atlantic coast from New Jersey to Texas, but is also found along the Pacific coast and in Hawaii.  
...
Once turtle life-stages with similar vital rates have been identified, three pieces of data (*transition rates*) must be collected to construct the stage-structured model:
...
In R, your projection matrix should look like this!
