...
In this lab we will continue to add complexity (and biological realism) to our population models in InsightMaker. Among the concepts we will explore are *parameter uncertainty*, *demographic stochasticity* and *environmental stochasticity*. We will cover this topic more in lecture next week, but I wanted you to have a chance to start playing around with these concepts in greater depth. 
...
For example, let's imagine annual birth rates ($b$) vary between 0.8 and 1.7. Here is the distribution of birth rates from a uniform random number generator:
...
2a. Provide a link to your InsightMaker model with demographic stochasticity, with settings changed so that the model will _run for 100 years_. 
...
2c. Use the plots from (2b) above to evaluate the following question: For which of the following is _demographic stochasticity_ a more important driver of population dynamics and extinction risk: higher initial abundance or lower initial abundance? Explain your answer.
...
Note that InsightMaker automatically insures that the birth rate is not negative (in-flows cannot draw out of the stock) and that the mortality process is not adding to the population (out-flows cannot add to the stock). 

2d. Embed the link to your InsightMaker model in your write-up. 
