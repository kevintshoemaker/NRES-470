...
In InsightMaker, change the "Birth rate" parameter $b$ (previously set at 0.2) to instead draw from a **uniformly distribution** with minimum of 0.15 and maximum of 0.25 (so that the random number generator always produces values within this range). 
