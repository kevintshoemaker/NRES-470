...
From a modeling standpoint, this is where things really get interesting- with species interactions, we really start to see some unexpected emergent properties!

Species interactions can be classified according to the effect of the interaction on each species: (+,+), (+,-), (+,0), (-,-), (-,0), (0,0)

**Q**: Can you name each of the above interaction classes?
