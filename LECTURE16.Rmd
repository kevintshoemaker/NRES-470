...
Sometimes the negative effect of one actor (individual of the same or another species) on another actor is due to direct behavioral exclusion. This is the case with birds that maintain territories and keep other birds off their territory. 
...
Species 1: $\Delta N_1 = r\cdot N_{1_t} \cdot (1-\frac{N_1}{K_1})$      

Species 2: $\Delta N_2 = r\cdot N_{2_t} \cdot (1-\frac{N_2}{K_2})$
