...
#### Exploitation
This is the kind of competition we probably think about first- all individuals are competing for resources and all have similar competitive abilities. It's a free-for-all: everyone gets some piece of a limited pie! But competition is indirect- that is, individuals of different species are interacting directly with a common resource pool, not with each other.   
