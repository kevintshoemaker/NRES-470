...
- Ignores **imperfect detection** (assumes no observation errors), which is almost always not realistic.
...
We will return to CMR data shortly (and in the optional Lab 7), but first...
