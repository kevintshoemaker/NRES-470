...
NOTE: we skipped over the [lecture on agent-based models](LECTURE10.html) and the [lecture on parameter estimation](LECTURE15.html)- these topics will *not be included on the final exam*
...
- Will accept up to two extra credit write-ups - one response essay for a published paper and another for a full-length seminar. 
