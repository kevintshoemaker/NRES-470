...
**when and where** The optional final exam is on Friday **May 6** (9:50am to 11:50) in our regular classroom. You will have the whole two hour period to take the exam (but you should not need the whole period). The exam will be in the same basic format as the midterm exams.
...
- All material covered in lectures, including the following web pages and corresponding lectures and top hat pages:    
    ...
    * [Parameter estimation](LECTURE15.html)
...
We will do a review session in class on Wed May 4 (regular class time, regular classroom). Please make note of any questions that come up as you study- we can talk these over during the review session! 

Margarete will also provide an additional office hour on Thursday May 5 (look for announcement).
