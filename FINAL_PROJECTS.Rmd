...
You will submit two rough drafts: one for our group peer review in lab, and the other so your instructor and TA can give detailed feedback. 
...
In lab on Fri Apr 23 we will have a "peer review" session where we will have a chance to give each other feedback on draft manuscripts. 

The way it will work is as follows:

1. By the end of the day on April 21 (Wed), you will receive another group's draft manuscript via WebCampus (see list below). 
