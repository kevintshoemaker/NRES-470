...
- **PROPOSAL:** Due Tues March 5!
- **INITIAL PVA** Due Fri April 5: description of how your PVA model works and where the parameter estimates come from.
- **DRAFT FINAL PAPER:** Due Tues April 16
- **FINAL FINAL PAPER:** Due Wed May 15
- **FINAL PRESENTATIONS:** Fri Apr 26 and May 3 in lab!
...
You will have 12 minutes to give your presentations, with at least 3 additional minutes for presenations.  
...
In lab on Fri Apr 19 we will have a "peer review" session where we will have a chance to give each other feedback on draft manuscripts. 

The way it will work is as follows:

1. By mid-day on April 17 (Wed), you will receive another group's draft manuscript via WebCampus (see list below). 

2. Before class on April 19, please throroughly read the manuscript you have been assigned, and make comments, paying particular attention to the [grading rubric](WrittenProject_rubric.docx). 
...
5. For the remaining time in lab, you will have a chance to work on your PVA write-ups and presentations!
...
- For all slides: *Less words, more pictures*! Wordy slides often cause people to stop paying attention! All of you are working with charismatic species (cheatgrass may be questionable on that front!), so you shouldn't have trouble finding nice pictures that capture people's attention. As for words, 3-5 bullet points maximum! Complete sentences are NOT needed in a presentation. Use a large, sans-serif font to improve readability.  
