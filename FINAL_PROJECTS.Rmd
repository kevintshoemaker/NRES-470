...
- **DRAFT FINAL PAPER:** Due Tues April 23
...
In lab on Fri Apr 26 we will have a "peer review" session where we will have a chance to give each other feedback on draft manuscripts. 

The way it will work is as follows:

1. By mid-day on April 24 (Wed), you will receive another group's draft manuscript via WebCampus (see list below). 

2. Before lab on April 26, please throroughly read the manuscript you have been assigned, and make comments, paying particular attention to the [grading rubric](WrittenProject_rubric.docx). 
