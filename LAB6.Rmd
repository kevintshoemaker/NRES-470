...
1. How many total occupied patches do we have in our metapopulation at time $t$?     
2. What fraction of the metapopulation is occupied at time $t$?    
...
## Exercises 1-3: 'classical' metapopulation models in InsightMaker
...
* Set $p_e$ to 0.3 (30% of occupied sites are exterpated each year)      
* Set $p_i$ to 0.5 (50% of unoccupied sites are colonized each year) 
* Initialize $f$ at 0.25   
...
* Set $p_e$ to 0.3 (30% of occupied sites are exterpated each year)      
* Set $i$ to 0.5 (colonization rate at very high occupancy)         
* Set $p_i$ to $i \times f$      
* Initialize $f$ at 0.25 
...
* Set $e$ to 0.9 (extinction rate at very low occupancy)
* Set $p_e$ to $e \times (1-f)$      
* Set $p_i$ to 0.5 (50% of unoccupied sites are colonized each year)      
* Initialize $f$ at 0.25  
...
## Exercise 4: a spatial metapopulation model!
...
Finally, imagine that this metapopulation represents the last remaining habitat for an endangered butterfly. You have identified three possible management strategies: Starting from the initial conditions specified at the beginning of this exercise, you could:    
...
***See WebCampus for due date***
  ...
  +  **Exercise 1**
      ...
      -  *Short answer, numeric (1b.)*   
      -  *Short answer (1c.)*
      -  *Image upload (1d.)*
      
  +  **Exercise 2**
      -  *InsightMaker link (2a.)*   
      -  *Short answer, numeric (2b.)*   
      -  *Image upload (2c.)*
      
  +  **Exercise 3**
      -  *InsightMaker link (3a.)*   
      -  *Short answer, numeric (3b.)*   
      -  *Image upload (3c.)*
      
  +  **Exercise 4**
      -  *Short answer and numeric (4a.)*
      -  *Short answer (4b.)*
      -  *Short answer (4c.)*
