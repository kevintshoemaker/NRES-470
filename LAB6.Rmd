...
How can a metapopulation become colonized? The answer is **immigration** of course.  
...
$f_t$ is the fraction, or proportion, of patches that are occupied at time $t$. This is also known as the **occupancy**
...
1h. Change your InsightMaker model to reflect the *rescue effect*. Restore the colonization model to represent "propagule rain" (constant colonization rate for vacant patches). Set the parameter $e$ to 0.25. Provide a link to your InsightMaker model as part of your lab write-up. 
