...
**when and where** The second midterm exam (out of two) is coming up on **April 15**. You will have the whole 50 minute class period to take the exam. The exam will take place in our regular classroom, unless you make prior arrangements. 

**what** The exam will cover:

- Everything from the first midterm      
- Matrix population models, including all of Gotelli Chapter 3          
- Stochasticity and uncertainty (lecture and lab)       
- Small-population paradigm, declining-population paradigm and PVA lectures        
- Metapopulations and source-sink dynamics (lectures and lab), including Chapter 4 of Gotelli.
    
*The exam will consist of a mixture of multiple-choice and short-answer questions.*  

I will host a review session via zoom on Monday April 13 at 5pm. See the zoom tab on webcampus for details.  

Finally, don't forget that lab 5 (stochasticity) is due at the end of this week -- Friday, April 10 -- along with your PVA models and justifications.
...
But -- in fact, many metapopulation models ('classical metapopulations', covered in this lecture and Gotelli's Chapter 4) don't consider individuals at all!  

## What is a metapopulation?

In *metapopulation ecology*, we are generally considering a **landscape** with a certain number of potentially habitable **patches** of habitat. 
...
To simplify, we often assume that all areas outside a patch are completely unsuitable (i.e., they are NOT habitat).   
...
Metapopulation ecology covers a wide range of scenarios- as long as there are distinct habitat patches in a landscape, and as long as there is some dispersal among patches, then it is a type of metapopulation. When there is a very high rate of dispersal (and mating) among patches, then the metapopulation is described as "panmictic" (perfect genetic connectivity).

NOTE: in some definitions (including for 'classical' metapopulations), a "metapopulation" is more narrowly defined as a set of patches with limited connectivity with at least some unoccupied patches at some points in time. I prefer the more inclusive definition!
...
Instead of investigating population dynamics, we are investigating *metapopulation occupancy dynamics*. That is, how the number of occupied patches (or the fraction of patches occupied) changes over time.

Under the classical model, it NOT a metapopulation unless some patches are unoccupied at some points in time!
...
[pause video and answer TopHat question]
