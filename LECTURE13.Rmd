...
**when and where** The second midterm exam (out of two) is coming up on **April 14**. You will have the whole 50 minute class period to take the exam. We will use the same format as the first midterm. 
