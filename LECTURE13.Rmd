...
### Upcoming midterm exam: April 17

**when and where** The second midterm exam (out of two) is coming up on **Wednesday April 17**. You will have the whole 50 minute class period to take the exam (really, you have the whole hour if you need it). We will use the same basic format as we used for the first midterm. 
...
We will do a review session in class on Monday April 15. Please make note of any questions that come up as you study- we can talk these over during the review session! 
...
A **pseudo-sink population** is defined as a patch with intrinsic rate of growth above zero (r>0) whose abundance is *artifically augmented* above its own carrying capacity by immigrants from nearby source populations. In isolation (in the absence of immigration from a nearby source population) a pseudo-sink would not go extinct (a true sink would go extinct!), but would settle down at a lower equilibrium abundance (i.e., its own carrying capacity). That is, a pseudo-sink *maintains an equilibrium abundance above its carrying capacity due to the influx of immigrants from one or more nearby source populations*.

One final definition:

If a sink habitat is also very attractive to a species, this can be considered a form of **ecological trap** (or **evolutionary trap**). This can happen when human land use practices (to which a species is not evolved) transforms what a focal species *perceives* as good habitat into a "death trap". For instance, some birds are evolved to nest in open fields. To these species, hayfields may seem like a good place to nest- but then the mowers and balers come through and destroy all the nests. Such habitat is an especially dangerous type of sink!! 
