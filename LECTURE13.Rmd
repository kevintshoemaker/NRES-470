...
5. Change the dispersal rate to 0.01 (1%). What happens now? Does the distant sink still function as a sink population? That is, is it occupied continuously? If not, what is the minimum dispersal rate that generally ensures that the distant sink is continuously occupied (make sure the lower bound of the 95% region for abundance in this patch is above 2 for all years)? [PointSolutions]
