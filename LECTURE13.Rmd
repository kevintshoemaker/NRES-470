...
**when and where** The second midterm exam (out of two) is coming up on **Wednesday April 197**. You will have the whole 50 minute class period to take the exam (really, you have the whole hour if you need it). We will use the same basic format as we used for the first midterm. 
