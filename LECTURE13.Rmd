...
### Upcoming midterm exam: April 19

**when and where** The second midterm exam (out of two) is coming up on **Wednesday April 19**. You will have the whole 50 minute class period to take the exam (really, you have the whole hour if you need it). We will use the same basic format as we used for the first midterm. 
...
We will do a review session in class on Monday April 17. Please make note of any questions that come up as you study- we can talk these over during the review session! 
...
**Q**: what is the analog of demographic stochasticity in a metapopulation model? [PointSolutions]
...
**Q**: What if the extinction of one patch was *perfectly correlated* with the extinction of all other patches. If one goes extinct, all go extinct. [PointSolutions] 
