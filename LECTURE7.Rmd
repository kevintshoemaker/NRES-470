...
For many species, vital rates may vary by size and not by age per se. For these species, stage-based models with stages defined by size may be much more realistic than age-based models. 
...
When a matrix is used to represent a stage-structured population, it is often called a **Lefkovitch Matrix** (or stage-based matrix). 
