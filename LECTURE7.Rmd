...
The commonly used 'Leslie Matrix' refers to an age-structured population matrix. When a matrix is used to represent a stage-structured population, it is often called a 'Lefkovitch" Matrix. 
