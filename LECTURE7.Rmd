...
**when and where** The first midterm exam (out of two) is coming up this Thursday **February 21**. You will have the whole 50 minute class period to take the exam. The exam will be in our regular classroom. 
...
You know what *is* great for projecting age-structured abundance into the future? (answer: MATRICES!)  
...
Initial_teasel <- matrix(c(1000,1500,200,300,600,25),ncol=1)         # initial population size (population vector)
