...
Finally, his economic argument can be summed up as follows:
...
Interestingly, in 1838 (four years after Malthus’ death), Charles Darwin, just back from his trip on HMS Beagle (1831–1836), was searching for possible mechanisms to explain the origin of species. On reading Malthus’ *Essay on the principle of population*, he realized one of the possible implications of the checks that controlled population growth (i.e., that the power of exponential growth means that many individuals will be born that won't be able to survive to adulthood due to resource limitations) and wrote: 
