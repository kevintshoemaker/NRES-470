...
Interestingly, in 1838 (four years after Malthus’ death), Charles Darwin, just back from his trip on HMS Beagle (1831–1836), was searching for possible mechanisms to explain the origin of species. On reading Malthus’ *Essay on the principle of population*, he realized one of the possible implications of the checks that controlled population growth (i.e., that the power of exponential growth, confronted with hard resource limitations, implies a 'population surplus' destined to die early) and wrote: 
...
**Q** Is this population ('famine condition' model) regulated? Is it sustainable? Why or why not?  [PointSolutions]   
