...
PVA is used for assessing how stochasticity and inbreeding can lead to extinction (small-population paradigm) and for assessing how to effectively reverse population declines and promote recovery (declining population paradigm).
...
- Do different populations have different mean vital rates (due to variations in habitat quality for example)? Are some populations likely to be sources and others likely to be sinks?   
