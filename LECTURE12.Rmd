...
Just a heads up about [final projects](FINAL_PROJECTS.html). Working PVA and document justifying decisions is *due next Monday, April 2*!
...
- Is environmental stochasticity **correlated**?
...
To illustrate some of these concepts, let's build a very simple PVA model in R.
