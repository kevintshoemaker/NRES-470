...
**Life Expectancy (for a newborn)** can be *approximated* as: $LE_0 = \sum_{x=0}^{k}l_{mid}\cdot (x)  \qquad \text{(Eq. 4)}$, where $l_{mid}(x)=\frac{l(x)+l(x+1)}{2}$ (lmid(x) is the approximate survivorship to the midpoint between age x and age x+1).     
