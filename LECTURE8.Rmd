...
**PointSolutions** In R, generate one random number from a Binomial distribution with 10 trials and probability of success equal to 0.3
...
**Q**: What type of uncertainty does this set of values most likely represent? What random number generator might you use to represent this uncertainty? [PointSolutions]
...
**Q**: what is the best-fit value for "mean"?  [PointSolutions]               
**Q**: what is the best-fit value for "sd"?  [PointSolutions]                        
