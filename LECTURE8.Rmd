...
**PointSolutions** In R, generate one random number from a Poisson distribution with mean of 2.1

**PointSolutions** In R, generate one random number from a Normal distribution with mean of 1.75 and standard deviation of 0.9 
