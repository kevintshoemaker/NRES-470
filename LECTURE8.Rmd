...
We will have a review session during our regular class meeting on the Monday prior to the exam (March 7). Please make note of any questions that come up as you study- we can talk these over during the review session!
...
A probability distribution can be pretty much anything you want it to be. However, there are several key types of probability distribution that come up again and again, and we should learn them!
...
**Q** What population parameter might the lognormal distribution be useful for modeling?
