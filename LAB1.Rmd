...
$$\frac{dN}{dt} = r \cdot N  \qquad \text{(Eq. 9)}$$ 

If you follow the rules of calculus to "solve" this differential equation (*integrate* this equation over time from the initial condition to time *t*), you get an equation that describes the population size at any given time $t$:
...
$$\lambda<1 \implies declining \space population$$
...
*  ***Short answer (1a.)*** [numeric response] Change the per-capita growth rate to 0.06 in cell D3. Based on what we did together in the demo, this should change the value of abundance in year 30 (cell B32) automatically. *What is the new final abundance at year 30?* assuming discrete annual population growth? 
...
HINT: use the EXP function in Excel to raise *e* (the base of the natural logarithm) to any power: for example, to compute $e^{0.06}$ you type "=EXP(0.06)" in Excel. 
...
*  ***Excel submission (1i.)*** [upload your Excel workbook] Please submit your final Excel workbook. If you used Google Sheets, please export as ".xslx" file to upload to WebCampus. 
...
Modify the above code to change $r_d$ to 0.06 (6% discrete annual growth) instead of 0.1, and run this model for 85 years instead of 30 years. Use this model to answer questions 2a and 2b: 

*  ***Short answer (2a.)*** [numeric response] What is the final population size at year 85 (with starting abundance of 100 and r=0.06)? 

*  ***Plot Upload (2b.)*** [image upload] Upload your plot (produced using R) of abundance vs time, illustrating population growth across the entire 85 year time span with 6% discrete annual growth. 

Modify the code again, this time change $r_d$ to 0.2 (20% annual discrete growth rate) instead of 0.06, and run this model again for 85 years. Use this model to answer questions 2c and 2d: 

*  ***Short answer (2c.)*** [numeric response] What is the final population size at year 85 (with starting abundance of 100 and 20% discrete annual growth)? 

*  ***Plot Upload (2d.)*** [image upload] Upload your plot (produced using R) of abundance vs time, illustrating population growth across the entire 85 year time span at 20% discrete annual growth. 
...
*  ***Short answer (2g.)*** [numeric response] Change the value of $r_d$ to -0.06 (6% discrete annual population *decline*). How long until the population goes extinct? NOTE: we will define extinction in this exercise as <1 individual in the population- a fraction of an individual is not much of a population! 
...
*  WebCampus short answers and file submissions
    ...
    +  **Exercise 2**
        ...
        -  *Copy and paste R code (2i.)*  Your R code should show that you were able to:        
            ...
            b. change $r$ to 0.2 and run for 85 years and plot the results;     
            c. identify a value of $r$ that gives a population size of 2000 after 85 years; and     
            d. change $r$ to -0.06 and run until the population goes extinct- and plot the results.    
