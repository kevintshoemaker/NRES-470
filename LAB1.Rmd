...
*  ***Text entry (2g.)*** Please copy and paste the R script you used to answer the above questions.
...
*  WebCampus short answers and file submissions
    ...
    +  **Exercise 2**
        ...
        -  *Image upload (2f.)*
        -  *Short answer (2g.)*
        -  *Copy and paste R code (2h.)*  Your R code should show that you were able to:        
