...
+ "*for every female in the population now*, we expect 1.1 offspring will be born this year"
...
*  ***Short answer (2a.)*** Tweak the above code to run for 85 years. Plot your results (abundance vs time). What is the final population size at year 85? 
...
*  ***Short answer (2c.)*** Try to tweak the value of $r$ such that the final population size after 85 years is 1000. What is the value of $r$? After you solve it by trial and error, try to solve this problem analytically using Eq. 10. Show your calculations.
...
*  Top Hat short answers and file submissions
    ...
    +  **Exercise 2**
        ...
        -  *Short answer (2c.)*
        -  *Short answer (2d.)*
        -  *Submit r script (2e.)*  Your R code should show that you were able to:        
