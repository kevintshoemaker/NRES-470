...
*  ***Image upload (2f.)*** After you solve this problem by trial and error (2e), try to solve this problem analytically (solve for $r$) using Eq. 10. Use scratch paper (or virtual scratch pad) to make your calculations, take a photo (or screenshot) and upload the image in WebCampus.  
