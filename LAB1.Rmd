...
*  ***Image upload (2f.)*** [image upload] After you solve this problem by trial and error (2e), try to solve this problem analytically (solve for $r_d$) using Eq. 16. Use scratch paper (or virtual scratch pad) to make your calculations (showing all your work as clearly as possible), take a photo (or screenshot) and upload the image in WebCampus.  
