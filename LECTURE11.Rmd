...
- Try changing the harvest process to be 10 individuals per year instead of 10% of the population per year (absolute harvest rate). 
...
**Q**: Can you identify some combinations of threats that are the opposite of synergistic (*"antergistic"?*) -- that is, conbinations that affect population decline or extinction risk less than simply adding the effects of each threat in isolation??
