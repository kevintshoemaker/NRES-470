...
This "debate" was ignited by a [very influential paper by Graeme Caughley](caughley1.pdf) in *Journal of Animal Ecology* in 1994.

![](caughley1.jpg){width=50%}

In this paper, Caughley coined the terms 'small population paradigm' and 'declining population paradigm', and argued forcefully that conservation biologists of his time were undervaluing one of these two paradigms and over-emphasizing the other:  
...
**Q**: What do you think? Do you agree with Caughley? Take a moment to look over the paper and please comment on Top Hat!
...
**Q**: What if you change the harvest rate- make it even more extreme? Starting at an abundance of 200, what is the expected final abundance (after 50 years) if the harvest rate is 40% and the variation (standard deviation) in harvest rate is 20%?   [Top Hat]
...
- Try changing the habitat loss process to be 5 *individuals* per year (absolute habitat loss) AND the harvest process to be 35 *individuals* per year (absolute harvest rate). What happens?   [Top Hat]
