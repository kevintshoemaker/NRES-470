...
Birth rate $b_t$ from life tables is the _per-capita rate of offspring production_ for age $t$ individuals (individuals that are exactly age t). We can think of this as the number of offspring produced per female at the moment they reach $t$ years of age.   
...
1a. Translate the above *life table* into a five-age-class transition matrix (age class 0 to age class 4). In your written lab report, provide the full transition matrix and describe the formula used to compute the matrix element in row 1 column 3. This is a bit harder than it sounds! 
...
- For recruitment, set *Recruitment rate, age 2* at 1.3 and *Recruitment rate, age 3* at 1.6.    
