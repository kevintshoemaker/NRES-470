...
author: "Applied Population Ecology, Spring 2023"
output:
  html_document: 
    theme: spacelab
    toc: yes
...
### Software   
- [InsightMaker- web-based systems modeling tool](https://insightmaker.com/)(free, no installation needed)        
- [R- software for statistical computing and graphics](https://cran.r-project.org/) (free, open-source)      
- Spreadsheet software (MS Excel, Google Sheets or equivalent)
- PointSolutions (interactive classroom software- sign up via WebCampus)
...
### PointSolutions
We will be using the PointSolutions interactive learning platform in class. You will be able to submit answers to in-class questions using Apple or Android smartphones and tablets, laptops, or through text message.  

You can sign up using the link on WebCampus. The cost is $15 per year for UNR students. For more information please see [https://www.unr.edu/digital-learning/tools-and-technologies/student-response-systems/pointsolutions-students](https://www.unr.edu/digital-learning/tools-and-technologies/student-response-systems/pointsolutions-students) 
