...
In the first period we will talk through the basics of population modeling for wildlife conservation, and I'll give some examples of how this method is used to advance wildlife conservation.

Second, we will run through a case study involving the piping plover, where we will use a population model to address questions about the benefits of nest protection (predator exclosures placed around nests) for this species. 

Let's review some basic population ecology theory - which is the foundation of PVA!
...
Populations operate within a broader ecosystem, interacting with their environment (e.g., resources) and with other species. These interactions result in positive and negative feedback loops, which in turn can lead to unexpected outcomes known as **emergent properties**, which in turn can help explain large-scale properties -- like the range of a species or the presence of a stable population equilibrium (like carrying capacity)! 

Mathematics gives us a language for unambiguously describing and modeling the **functional relationships** between system components and the processes driving system dynamics.   
...
Armed with basic facility with mathematics and computer programming, ecologists and natural resource professionals can *formalize their understanding* of the natural systems in which they work, building models that account for complex ecological realities. 

In addition, we can run virtual "experiments", or **scenario tests** using these models, asking questions that wouldn't otherwise be addressable through science. For example, to assess which conservation or management actions are most likely to succeed! 

### A simple population simulation model
...
Any **dynamical system** (like a wildlife population) essentially consists of [Stocks] and [Flows].
...
This demonstration model is wrong, and not super useful! But at least it's a start!
...
2. Click on [this link](https://insightmaker.com/insight/162300/NRES-421-In-Class-Demo-1) to load up the first population modeling demo.

3. In the upper left corner of the screen, click on the "Clone" link at the top so you can make your own copy of the model (that you can edit). If you want, you can change the name of the model by clicking on the white space anywhere in the workspace and then clicking the "Edit Info" button on the left-hand context menu.  
...
2. In the upper left corner of the screen, click on the "Clone" link at the top so you can make your own copy of the model. If you want, you can change the name of the model by clicking on the whitespace anywhere in your InsightMaker workspace and then clicking the "Edit Info" button on the left-hand context menu.
...
[Key PPT slides for exercises](REKN2.pptx)
