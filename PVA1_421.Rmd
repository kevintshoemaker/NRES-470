...
Populations of iving things have the ability to grow exponentially. This is the "power of life". 
...
**Q**: Is this extinction risk acceptable?
...
In this model, did the *population vital rates* change at all? If not, why does it look different each time we run the model?

**Please write down your responses to the following questions:**

**Question 1** Is the effect of *demographic stochasticity* bigger (more pronounced) at low or high abundances?

**Question 2** Is there any risk of extinction when the initial abundance is 10? What about when the initial abundance is 500?
...
**Question 3** Does the population-level impact of *environmental stochasticity* depend on the initial abundance? If so, how? 

**Question 4** Can you envision any circumstance(s) where small populations would be more vulnerable to *environmental stochasticity* than large populations? (this is open-ended, there is no one right answer!)
...
The first step (after you have formulated your research questions, of course!) is to conceptualize the key life history traits that you need to know to address your main questions. It can help to draw a *life history diagram* (essentially a stock-and-flow diagram!). In general, the following life history traits are often critical to consider:
