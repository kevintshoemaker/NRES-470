...
In this short course, we will explore the use of **population simulation models** to address conservation questions-- a process often called **population viability analysis (PVA)** 
...
![](Human_population_growth_from_1800_to_2000.png){width=30%}

![](positivefeedback1.png){width=30%}
...
## Systems thinking and computer modeling
