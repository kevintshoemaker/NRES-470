...
What is a **generation**? The most common definition is the _Average age of the parents of all the offspring produced by a single cohort_. This can be computed from the life table as:
