...
The fecundity component of the life table is called the "fecundity schedule"! The term $b(x)$ represents the per-capita birth rate for females of age x. The fecundity schedule describes how birth rate changes with age.   
...
There are three main types of survivorship curve (survivorship schedule), and these curves are classified as **Type I**, **Type II**, and **Type III**.
