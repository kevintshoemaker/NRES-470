...
Death_rate <- c(seq(0.5,0.05,length=5),seq(0.02,0.02,length=16),seq(0.02,0.2,length=4))
...
What is a **generation**? The most common definition (for generation time) is the _Average age at which individuals in a cohort produce offspring_ (consider all the offspring produced by the cohort- what is the average age of their parents?). This can be computed from the life table as:
